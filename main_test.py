...
def parse_agrs():
    ...
    parser.add_argument('--save_dir', type=str, default='results/KGEN', help='the patch to save the models.')
    ...
    parser.add_argument('--load', type=str, default="results/KGEN/model_best_7.pth", help='whether to load the pre-trained model.')
