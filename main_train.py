...
def parse_agrs():
    ...
    # VTFCM
    parser.add_argument("--useVTFCM", action="store_true", help="do you use MAM?")

    # KL
    parser.add_argument("--useKG", action="store_true", help="do you use MAM?")

    # Data loader settings
    parser.add_argument('--dataset_name', type=str, default='mimic_cxr', choices=['iu_xray', 'mimic_cxr'],
                        help='the dataset to be used.')
    parser.add_argument('--embed_dim', type=int, default=49, help='the maximum sequence length of the reports.')
    parser.add_argument('--max_seq_length', type=int, default=60, help='the maximum sequence length of the reports.')
    parser.add_argument('--threshold', type=int, default=3, help='the cut off frequency for the words.')
    parser.add_argument('--num_workers', type=int, default=2, help='the number of workers for dataloader.')
    parser.add_argument('--batch_size', type=int, default=24, help='the number of samples for a batch')
    ...
    parser.add_argument('--d_model', type=int, default=1024, help='the dimension of Transformer.')
    parser.add_argument('--d_ff', type=int, default=1024, help='the dimension of FFN.')
    ...
    parser.add_argument('--cmm_dim', type=int, default=1024, help='the dimension of cmm dimension.')
